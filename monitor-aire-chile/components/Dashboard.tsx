...
export function Dashboard({ stations }: DashboardProps) {
  ...
  return (
    <>
      {/* Label/Title for the emergency states */}
      <div className="px-6 md:px-12 max-w-[1400px] mx-auto mb-3">
        <h3 className="text-xs font-extrabold uppercase tracking-[0.08em] text-[#6e685e] dark:text-slate-400 flex items-center gap-1.5">
      ...
      <section id="tour-stats" className="px-6 md:px-12 max-w-[1400px] mx-auto mb-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6 scroll-mt-24">
        {[
